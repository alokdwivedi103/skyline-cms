...
import { FaSearch, FaShoppingCart, FaUser, FaBars, FaTimes, FaFacebook, FaTwitter, FaInstagram, FaSignOutAlt } from 'react-icons/fa';
            ...
            <div className="flex items-center space-x-4">
              ...
              {isAuthenticated ? (
                <div className="relative group hidden md:block">
                  <Link href="/account" className="flex items-center space-x-2 text-primary hover:text-primary-light transition-colors py-2">
                    <FaUser className="w-5 h-5" />
                    <span className="text-sm font-medium">Hi, {user?.name.split(' ')[0]}</span>
                  </Link>
                  {/* Dropdown */}
                  <div className="absolute right-0 top-full w-48 bg-white shadow-lg rounded-b-lg overflow-hidden hidden group-hover:block border-t-2 border-primary">
                ...
                <Link href="/account/login" className="hidden md:flex items-center space-x-2 text-primary hover:text-primary-light transition-colors">
                  <FaUser className="w-5 h-5" />
